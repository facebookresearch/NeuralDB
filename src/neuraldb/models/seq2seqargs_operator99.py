...
from neuraldb.dataset.nuo_generator.d1_seq2seq_generator import (
    D1Seq2SeqSpecificGenerator,
)
...
class Seq2seqOperatorTrainer99(BaseTransformer):
    ...
    def construct_model(self, cache_dir):
        if not hasattr(self.hparams, "random_init") or not self.hparams.random_init:
            return super(Seq2seqOperatorTrainer99, self).construct_model(cache_dir)
    ...
    def construct_generator(self):
        return D1Seq2SeqSpecificGenerator(
            self.tokenizer,
