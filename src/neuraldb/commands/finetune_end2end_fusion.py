...
from neuraldb.models.seq2seqargs_fusion import Seq2seqFusionTrainer
...
def main(args):
    ...
    model = Seq2seqFusionTrainer(args)
...
if __name__ == "__main__":
    ...
    parser = Seq2seqFusionTrainer.add_model_specific_args(parser, os.getcwd())
