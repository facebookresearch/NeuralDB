...
from modelling.common.seq2seq_trainer import Seq2SeqTrainer
...
class DataTrainingArguments:
    ...
    train_path: str = field(
        metadata={"help": "The training data file. Should contain the .tsv files (or other data files) for the task."}
    )
    val_path: str = field(
        metadata={"help": "The validation data file. Should contain the .tsv files (or other data files) for the task."}
    )
