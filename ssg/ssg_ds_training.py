...
from ssg.ssg_utils import read_NDB_v2, create_dataset_v2, create_dataset_ds_v2

folder = 'v1.6_25_ds_sg_5'
...
dataset = create_dataset_ds_v2(db)
...
model.fit(train_objectives=[(train_dataloader, train_loss)], epochs=10, warmup_steps=100, evaluator=evaluator,
          output_path="ssg-sentencetransformer-alldata-weighted-1.6-ds", evaluation_steps=5000)
