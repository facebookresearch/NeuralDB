...
from neuraldb.dataset.e2e_reader.v0_5_database_reader import V5D2DatabaseSpecificReader
...
class Seq2seqOperatorTrainer2(BaseTransformer):
    def __init__(self, hparams):
        ...
        self.dataset_reader = self.get_dataset_reader("v0.5")
    ...
    def test_epoch_end(self, outputs):
        ...
        for s, pred, t, meta in zip(sources, preds, targets, meta):
            ...
            em += local_score
            # big_score_breakdown["breakdown_prop"][meta["prop"] if "prop" in meta else meta["relation"]].append(local_score)
    ...
    def get_dataloader(
        ...
        ds = GenericDataset(
            self.reader, self.data_generator, auto_pad=True, percentage=percentage
        )
        ds.read(type_path)
