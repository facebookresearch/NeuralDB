...
from neuraldb.models.seq2seqargs_operator_2 import Seq2seqOperatorTrainer2
...
def main(args):
    ...
    model = Seq2seqOperatorTrainer2(args)
...
if __name__ == "__main__":
    ...
    parser = Seq2seqOperatorTrainer2.add_model_specific_args(parser, os.getcwd())
