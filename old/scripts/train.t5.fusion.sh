...
OUTPUT_DIR=${WORK_DIR:-.}/experiment=${experiment}/dataset=ndb,model=t5-base,retrieval=tfidf,version=${version}/lr=${lr},filter_size=${filter_size}/context=${context}/seed-${seed}
