...
OUTPUT_DIR=${WORK_DIR:-.}/final=true/experiment=${experiment}/dataset=ndb,model=t5-base,version=${version}/lr=${lr}/context=${context},filters=${filters},max_queries=${max_queries}/seed-${seed}
