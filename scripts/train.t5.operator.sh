...
OUTPUT_DIR=${WORK_DIR:-.}/experiment=${experiment}/dataset=operator,model=t5-base,version=${version}/lr=${lr}/filters=${filters},train_percentage=${train_percentage}/seed-${seed}
